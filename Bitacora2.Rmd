...
Para determinar si al solicitante se le dará el crédito, el umbral será del 0.5, por lo que si el resultado de la regresión es mayor a 0.5, se le da el crédito y en caso contrario no. Los resultados de la regresion
...
El resultado de la regresión arroja una curva ROC como se muestra a continuación:
